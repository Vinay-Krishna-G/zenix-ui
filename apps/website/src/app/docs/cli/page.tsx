export default function CliDocsPage() {
  return (
    <div style={{ maxWidth: '800px' }}>
      ...
      <pre style={{ margin: '0 0 2rem', padding: '1.5rem', background: 'var(--zx-elevated)', borderRadius: 'var(--zx-radius-surface)', overflowX: 'auto', fontSize: '0.875rem', fontFamily: 'monospace' }}>
        {`npx zenix-ui add midnight-portfolio`}
      </pre>

      <div style={{ padding: '1.5rem', background: 'var(--zx-surface)', border: '1px solid var(--zx-elevated)', borderRadius: 'var(--zx-radius-surface)', marginBottom: '4rem' }}>
