          ...
          return (
            <div key={collection.title}>
              ...
              <div style={{ 
                ...
                {rowExps.map(exp => (
                  <Link key={exp.id} href="/launchpad" style={{ textDecoration: 'none', color: 'inherit', flexShrink: 0, width: '460px', scrollSnapAlign: 'start' }}>
                    <div style={{ 
                    ...
                    >
                      ...
                      <div style={{ padding: '2.5rem', flex: 1, display: 'flex', flexDirection: 'column', background: '#09090B' }}>
                        <p style={{ fontSize: '1.25rem', opacity: 0.8, marginBottom: '2.5rem', fontWeight: 500, lineHeight: 1.6 }}>{exp.marketingCopy}</p>
